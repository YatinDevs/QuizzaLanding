...
function Profile() {
  return (
    <>
      <div className="flex-col sm:flex-row border border-solid border-orange-500 rounded-lg flex truncate flex-auto items-center  w-[168px] h-11 px-[10px] gap-2 m-3  cursor-pointer max-sm:w-fit">
        <img
